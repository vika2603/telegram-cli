// Package archive implements "tg chat archive <ref>".
package archive
...
// New builds the cobra command for "tg chat archive".
func New(f *runtime.Invocation, runF func(*Options) error) *cobra.Command {
	opts := &Options{}
	cmd := &cobra.Command{
		Use:   "archive <ref>",
		Short: "Move a chat to the archive folder",
...
func Run(ctx context.Context, opts *Options) error {
	row, err := actionchat.Archive(ctx, actionchat.FolderRequest{RawRef: opts.RawRef}, opts.Do)
	if err != nil {
		return err
	}
