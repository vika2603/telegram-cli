...
func New(f *runtime.Invocation, runF func(*Options) error) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "create <title>",
		Short: "Create a supergroup or channel",
	...
	cmd.Flags().BoolVar(&opts.Channel, "channel", false, "Create a broadcast channel instead of a supergroup")
